...
$html .= '<div class="features-outer-box">
    ...
    <div class="banner shadow">These Videos Feature Version 2.2.0, But The Instructions Are The Same For Version 2.3.0 And Above</div>
    <div class="video-box">
        ...
        <div>
            ...
            <p class="video-text-18"><span class="alert">Note:</span> This is a 38 minute video.</p>
        </div>
    </div>
    <hr>
    <div class="video-box">
        ...
        <div>
            ...
            <p class="video-text-18"><span class="alert">Note:</span> This is a 27 minute video.</p>
        </div>
    </div>
    <br>
    <br>
    <div class="banner shadow">This Video Showcases The Group Messaging Feature Released in Version 2.3.1</div>
    <div class="video-box">   
        ...
        <div>
            ...
            <p class="video-text-18"><span class="alert">Note:</span> This is a 1 hour, and 30 minute video.</p>
        </div>
    </div>
    <hr>
    <br>
